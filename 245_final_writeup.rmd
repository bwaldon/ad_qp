...
This model revealed that difference in response between the priming trials and critical trial was a significant predictor of response on the critical trial (p < 0.0001). (The code for all post-hoc analyses can be found in the markdown file of this document, accessible in the repository). 
...
Future empirical work should also investigate whether similar effects can be elicited in different implicature paradigms, including *some*/*all*, cardinal numbers, and scalar adjectives. 

# Appendix

The below table summarizes behavior in the several conditions where there was no utterance prime:
