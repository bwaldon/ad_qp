...
function init() {
  exp.trials = [];
  exp.catch_trials = [];
  exp.condition = _.sample(["or_eitherorprime_exclu", "or_notbothprime_exclu", "or_andprime_exlcu", "or_noprime_exclu", "or_eitherorprime_orthog", "or_notbothprime_orthog", "or_andprime_orthog", "or_noprime_orthog", "or_noprime_orthog_firstconj", "or_noprime_oneshot"]); //can randomize between subject conditions here
